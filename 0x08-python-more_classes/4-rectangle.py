...
class Rectangle:
    """A module that defines a rectangle with attributes and methods"""
    ...
    @property
    def width(self):
        """Getter/setter method for the width of the rectangle"""
        return self.__width
    ...
    @property
    def height(self):
        """Getter/setter module for the height of the rectangle"""
